  ...
  return (
    <div style={overlay}>
      <div style={card}>
        ...
        <ol style={{ textAlign: 'left', color: 'var(--muted)', lineHeight: 2, paddingLeft: '1.25rem', marginBottom: '1.5rem' }}>
          <li>Tap the <strong style={{ color: 'var(--text)' }}>Share</strong> button at the bottom of Safari (the box with an arrow)</li>
        ...
        <button
          style={{ background: 'none', border: 'none', color: 'var(--subtle)', fontSize: '0.85rem', cursor: 'pointer' }}
